...
function wp_credits($atts){
    ...
    wp_enqueue_style("wp_credits-fancybox",URL_WP_CREDITS."/front/css/jquery.fancybox.min.css", array(),"");
    wp_enqueue_style("wp_credits-css",URL_WP_CREDITS."/front/css/styles.css", array(),"1.0");

    wp_enqueue_script("wp_credits-fancybox",URL_WP_CREDITS."/front/js/jquery.fancybox.min.js", array("jquery"), "",false);
    ...
    wp_enqueue_script("wp_credits-js",URL_WP_CREDITS."/front/js/custom.js", array("jquery","wp_credits-alerts","wp_credits-priceformat","wp_credits-fancybox"), "1.0",false);
